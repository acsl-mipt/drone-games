1.4.0 (21.04.2021)
-----------------
* Изменен режим симуляции (возвращен lockstep, обновление из upstream репозитория)
* Система автоматического судейства
* Миры и данные скриптов выдачи для финального дня
* Финальные результаты, протоколы, видеозаписи.
...
* Добавлен ЧаВо ([FAQ](.resources/FAQ.md))
